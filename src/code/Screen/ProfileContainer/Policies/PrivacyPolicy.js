    ...
    <SafeAreaView style={{flex: 1}}>
      <ScrollView style={styles.container}>
        ...
        <Text style={styles.paragraph}>
          ...
          control. We shall in no way be responsible in any way for your use of
          such sites.
        </Text>
        ...
        <Text style={styles.paragraph}>
          We share the sensitive personal information with any third party
        ...
        <Text style={styles.paragraph}>
          ...
          below via in writing or through email signed with the electronic
          signature to Ms. Dhanalakshmi ("Grievance Officer").
        </Text>

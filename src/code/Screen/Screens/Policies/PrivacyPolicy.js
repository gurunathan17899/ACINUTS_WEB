  ...
  return (
    ...
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.paragraph}>
        ...
        refer to ACI Traders and the terms "You" /"Your" / "Yourself" refer to
        the users.
      </Text>
      ...
      <Text style={styles.paragraph}>
        This Privacy Policy is a legally binding document between you and ACI
        TRADERS (both terms defined below). The terms of this Privacy Policy
        will be effective upon your acceptance of the same (directly or
        indirectly in electronic form, by clicking on the I accept tab or by use
        of the website or by other means) and will govern the relationship
        between you and ACI TRADERS for your use of the website “Website”
        (defined below).
      </Text>
      ...
      <Text style={styles.paragraph}>
        ...
        Non-Personal Information by us as specified under this Privacy Policy.
      ...
      <Text style={styles.paragraph}>
        ...
        of this is when you ask for our Personalized Horoscope). A cookie cannot
      ...
      <Text style={styles.paragraph}>
        Our policy discloses the privacy practices for our own website only. Our
        site provides links to other websites also that are beyond our control.
        We shall in no way be responsible in any way for your use of such sites.
      </Text>

      <Text style={styles.subheading}>INFORMATION SHARING</Text>

      <Text style={styles.paragraph}>
        We share the sensitive personal information with any third party without
      ...
      <Text style={styles.paragraph}>
        (b) We propose to share such information within its group companies and
      ...
      <Text style={styles.subheading}>INFORMATION SECURITY</Text>
      ...
      <Text style={styles.subheading}>Grievance Redressal</Text>
      ...
      <Text style={styles.paragraph}>
        ...
        writing or through email signed with the electronic signature to Ms.
        Dhanalakshmi ("Grievance Officer").
      </Text>

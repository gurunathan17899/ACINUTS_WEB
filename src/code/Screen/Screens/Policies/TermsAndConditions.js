    ...
    <ScrollView style={styles.container}>
     <View style={{flexDirection: 'row', justifyContent: 'center',marginBottom:20}}>
      ...
      <Text style={styles.paragraph}>
        The terms "We" / "Us" / "Our"/”Company” individually and collectively refer to ACI TRADERS, and the terms "Visitor” ”User” refer to the users.
      </Text>
      ...
      <Text style={styles.paragraph}>
        All logos, brands, marks headings, labels, names, signatures, numerals, shapes, or any combinations thereof, appearing on this site, except as otherwise noted, are properties either owned or used under license by the business and/or its associate entities who feature on this Website. The use of these properties or any other content on this site, except as provided in these terms and conditions or in the site content, is strictly prohibited. You may not sell or modify the content of this Website or reproduce, display, publicly perform, distribute, or otherwise use the materials in any way for any public or commercial purpose without the respective organisation’s or entity’s written permission.
      </Text>
      ...
      <Text style={styles.sectionTitle}>6. Disclaimer of Consequential Damages</Text>
      <Text style={styles.paragraph}>
